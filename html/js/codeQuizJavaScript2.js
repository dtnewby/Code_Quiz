...
var qAndA = { question: "In JavaScript, commonly used data types are...?", 
answer1: "1-booleans", answer2: "2-Strings", answer3: "3-numbers", answer4: "4-all of the above", rightAnswer: "button4" };
...
function gradeAnswer(event) 
{
    ...
    setTimeout(function() { window.location.href = "codeQuizPage3.html"; }, 1000);    
}
