...
var qAndA = { question: "In JavaScript, Arrays store...?", 
answer1: "1-strings", answer2: "2-numbers", answer3: "3-objects", answer4: "4-all of the above", rightAnswer: "button4" };
...
function gradeAnswer(event) 
{
    ...
    setTimeout(function() { window.location.href = "codeQuizPage4.html"; }, 1000);    
}
